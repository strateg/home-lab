...
7. local full validation run passed (`python -m pytest -o addopts= v5/tests -q` -> `302 passed`; `lane.py validate-v5` -> `PASS`).
...
11. post-hardening full suite re-run passed (`302 passed` + `lane validate-v5 PASS`).
