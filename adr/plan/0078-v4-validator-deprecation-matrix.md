...
| references.py | `check_host_os_refs` | `base.validator.references`, `base.validator.embedded_in`, `base.validator.runtime_target_os_binding`, `base.validator.host_os_refs` | Covered/Partial | Keep v4 fallback until project fixtures confirm parity for non-extension host_os data paths and cutover gate is approved. |
| references.py | `check_vm_refs` | `base.validator.references`, `base.validator.vm_refs` | Covered/Partial | Keep v4 fallback for remaining architecture/capability policy edge cases. |
| references.py | `check_lxc_refs` | `base.validator.references`, `base.validator.lxc_refs` | Covered/Partial | Keep v4 fallback for remaining architecture/capability policy edge cases. |
