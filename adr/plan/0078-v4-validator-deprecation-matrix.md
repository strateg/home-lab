...
| references.py | `check_host_os_refs` | `base.validator.references`, `base.validator.embedded_in`, `base.validator.runtime_target_os_binding`, `base.validator.host_os_refs` | Covered/Partial | Keep v4 fallback for remaining host_os capability-policy and strict canonical-architecture semantics. |
