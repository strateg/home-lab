...
| [0083](0083-unified-node-initialization-contract.md) | Unified Node Initialization Contract and Deploy-Domain Initialization Phase | Proposed (Deferred/Optional) | 2026-03-30 | - | - |
| [0084](0084-cross-platform-dev-plane-and-linux-deploy-plane.md) | Cross-Platform Dev Plane and Linux Deploy Plane | Accepted (runner complete) | 2026-03-31 | - | - |
| [0085](0085-deploy-bundle-and-runner-workspace-contract.md) | Deploy Bundle and Runner Workspace Contract | Accepted (runner complete; bundle pending) | 2026-03-31 | - | - |
