...
def main():
    ...
    parser.add_argument(
        "--output-dir",
        default=None,
        help="Output directory (default: v4-generated/bootstrap/rtr-mikrotik-chateau)",
    )
    parser.add_argument(
        "--password",
    ...
    print("=" * 70)
    print()
    print(f"Path A (minimal): {result['bootstrap_script']}")
    print(f"Path B (backup):  {result['bootstrap_script_backup']}")
    print(f"Path C (rsc):     {result['bootstrap_script_rsc']}")
