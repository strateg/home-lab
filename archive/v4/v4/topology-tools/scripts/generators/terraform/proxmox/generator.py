...
class TerraformGenerator(TerraformGeneratorBase):
    ...
    def print_summary(self) -> None:
        ...
        print("  2. Copy terraform.tfvars.example to local/terraform/proxmox/terraform.tfvars")
        print("  3. Edit local/terraform/proxmox/terraform.tfvars with your credentials")
        print("  4. Run: cd deploy && make assemble-native")
        print("  5. Run: cd .work/native/terraform/proxmox && terraform init -upgrade")
        print("  6. Run: terraform plan")
        print("  7. Run: terraform apply")
