...
def main() -> int:
    ...
    parser.add_argument(
        "--fixtures-root",
        default="v4/topology-tools/fixtures",
    ...
    parser.add_argument(
        ...
        action="store_true",
        help="Skip new-only comparison against repository v4-generated/ snapshots",
    )
    parser.add_argument(
    ...
    tools_dir = project_root / "v4" / "topology-tools"
    ...
    try:
        for spec in specs:
            ...
            if spec.name == "new-only" and not args.skip_canonical_compare:
                checks = (
                    (project_root / "v4-generated" / "terraform", output_root / "terraform", False),
                    (project_root / "v4-generated" / "terraform-mikrotik", output_root / "terraform-mikrotik", False),
                    (
                        project_root / "v4-generated" / "ansible" / "inventory" / "production",
                        output_root / "ansible" / "inventory" / "production",
                        False,
                    ),
                    (project_root / "v4-generated" / "docs", output_root / "docs", True),
                )
