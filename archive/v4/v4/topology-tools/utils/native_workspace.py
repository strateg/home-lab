...
GENERATED_ROOT = REPO_ROOT / "v4-generated"
...
def _materialize_mikrotik(report: NativeAssemblyReport, repo_root: Path) -> None:
    _copy_tree(
        repo_root / "v4-generated" / "terraform" / "mikrotik",
    ...
    _copy_tree(
        repo_root / "v4-generated" / "bootstrap" / "rtr-mikrotik-chateau",
...
def _materialize_proxmox(report: NativeAssemblyReport, repo_root: Path) -> None:
    _copy_tree(
        repo_root / "v4-generated" / "terraform" / "proxmox",
    ...
    _copy_tree(
        repo_root / "v4-generated" / "bootstrap" / "srv-gamayun",
        bootstrap_root,
        report,
    )
    report.extend_materialized(
...
def _materialize_orangepi5(report: NativeAssemblyReport, repo_root: Path) -> None:
    ...
    _copy_tree(
        repo_root / "v4-generated" / "bootstrap" / "srv-orangepi5",
        bootstrap_root,
        report,
    )
    report.extend_materialized(
