...
DEFAULT_OUTPUT_DIR = REPO_ROOT / "v4-generated" / "ansible" / "inventory" / DEFAULT_ENV
...
class AnsibleInventoryGenerator:
    ...
    def __init__(
        ...
        topology_path: str,
        output_dir: str,
        templates_dir: str = str(REPO_ROOT / "v4" / "topology-tools" / "templates"),
    ):
    ...
    def print_summary(self):
        ...
        print("  2. Assemble runtime inventory: python3 v4/topology-tools/assemble-ansible-runtime.py")
...
def main():
    ...
    parser.add_argument(
        "--templates",
        default=str(REPO_ROOT / "v4" / "topology-tools" / "templates"),
