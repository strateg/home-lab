...
SECRETS_DIR="${WORKSPACE_ROOT}/projects/home-lab/secrets"
...
echo ""
echo "Next steps:"
echo "  1. ./scripts/secrets/unlock-secrets.sh"
echo "  2. Re-encrypt secrets: cd projects/home-lab/secrets && for f in */*.yaml; do sops updatekeys -y \"\$f\"; done"
echo ""
