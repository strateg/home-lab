...
def _topology_framework_section(layout: str, *, framework_mount: str, framework_root: Path) -> dict[str, str]:
    if layout == "monorepo":
        ...
        return {
            ...
            "capability_catalog": f"{prefix}/class-modules/capability-catalog.yaml",
            "capability_packs": f"{prefix}/class-modules/capability-packs.yaml",
        }
    ...
    return {
        ...
        "capability_catalog": _mounted_path(
            framework_root,
            framework_mount,
            ["topology/class-modules/capability-catalog.yaml", "class-modules/capability-catalog.yaml"],
        ),
        "capability_packs": _mounted_path(
            framework_root,
            framework_mount,
            ["topology/class-modules/capability-packs.yaml", "class-modules/capability-packs.yaml"],
        ),
    }
