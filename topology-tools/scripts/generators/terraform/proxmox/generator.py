...
class TerraformGenerator:
    ...
    def generate_versions(self) -> bool:
        ...
        try:
            ...
            content = template.render(topology_version=self.topology.get("L0_meta", {}).get("version", "4.0.0"))
    ...
    def generate_bridges(self) -> bool:
        ...
        try:
            ...
            content = template.render(
                bridges=bridges, topology_version=self.topology.get("L0_meta", {}).get("version", "4.0.0")
            )
    ...
    def generate_outputs(self) -> bool:
        ...
        try:
            ...
            storage = sorted(
                self._build_storage_map().values(), key=lambda item: str(item.get("id") or item.get("name") or "")
            )
