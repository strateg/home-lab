...
from validation.checks.storage import (
    ...
    normalize_device_storage_inventory,
...
class SchemaValidator:
    ...
    def _storage_disk_port_compatibility() -> Dict[str, Set[str]]:
        return storage_disk_port_compatibility()

    @staticmethod
    def _storage_mount_port_compatibility() -> Dict[str, Set[str]]:
        return storage_mount_port_compatibility()

    def _l1_storage_context(self) -> Dict[str, Any]:
        return build_l1_storage_context(self.topology or {})
    ...
    def _normalize_device_storage_inventory(self, device: Dict[str, Any], storage_ctx: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        if storage_ctx is None:
            storage_ctx = self._l1_storage_context()
        return normalize_device_storage_inventory(device, storage_ctx=storage_ctx)
