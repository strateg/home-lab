...
PROJECT_ROOT = TOPOLOGY_TOOLS_DIR.parent.parent
...
class MikrotikBootstrapDeployer:
    ...
    def __init__(
        ...
        self.bootstrap_script = bootstrap_script or (
            PROJECT_ROOT / "v4-generated" / "bootstrap" / "rtr-mikrotik-chateau" / "init-terraform.rsc"
        )
...
def main():
    ...
    parser.add_argument(
        "--script",
        default=None,
        help="Path to bootstrap script (default: v4-generated/bootstrap/rtr-mikrotik-chateau/init-terraform.rsc)",
    )
    parser.add_argument(
        "--generate",
        action="store_true",
