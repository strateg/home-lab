...
Example:
    python3 topology-tools/generate-proxmox-answer.py topology.yaml answer.toml
"""
...
Examples:
  ...
  %(prog)s topology.yaml answer.toml
  ...
  %(prog)s topology.yaml answer.toml --static
    ...
    parser.add_argument(
        ...
        nargs="?",
        default="answer.toml",
        help="Output path for answer.toml (default: answer.toml)",
    )
